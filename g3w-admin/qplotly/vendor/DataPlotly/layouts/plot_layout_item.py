...
from qplotly.utils.qplotly_settings import QplotlySettings as PlotSettings
from qplotly.utils.qplotly_factory import QplotlyFactoring as PlotFactory
from qplotly.vendor.DataPlotly.core.plot_factory import FilterRegion
...
class PlotLayoutItem(QgsLayoutItem):
    ...
    def create_plot(self):
        ...
        if len(self.plot_settings) == 1:
            plot_factory = PlotFactory(self.plot_settings[0], self, polygon_filter=polygon_filter, request=None,
                                       layer=None)
